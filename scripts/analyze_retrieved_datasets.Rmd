...
dataset <- dataset[dataset$source != "semantic_scholar" & dataset$source != " ",]
...
dataset_rel <- dataset_rel[dataset_rel$dataset_relevance != "cant access",]
...
ggsave("plot_location_inf.png", height = 5, width = 10)
...
plot_relevance_source <- ggplot(df_rel_source_melt, 
  ...
  scale_x_discrete(limits = rev(levels(df_rel_source_melt$relevance)))+
    ...
    xlab("relevance")+
    ylab("dataset counts") +
    scale_color_manual(values = c("red", "green","blue", "grey40"))+
...
plot_source_time <- ggplot(df_plot_source_time, aes(x = year, y = N, group = source, color = source)) +
  ...
  scale_x_discrete(guide = guide_axis(n.dodge=2))+
    scale_color_manual(values = c("semantic_scholar" = "green", "dryad" = "red", "zenodo" = "blue"),
